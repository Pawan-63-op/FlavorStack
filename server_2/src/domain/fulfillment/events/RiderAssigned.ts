// Domain event raised when a rider accepts a delivery offer (fulfillment_module.md §5.2).
// aggregateId = fulfillmentId; key payload: riderId, assignedAt. Routed to QUEUE.notification (§5.3).

export interface FulfillmentConfig {
  ...
  /** Search radius for ranking riders around the pickup restaurant. */
  assignmentRadiusMeters: number;
...
export function getFulfillmentConfig(): FulfillmentConfig {
  return {
    ...
    assignmentRadiusMeters: Number(process.env.FULFILLMENT_ASSIGNMENT_RADIUS_METERS ?? 8000),

...
import { CompleteDeliveryDto } from '../dtos/CompleteDeliveryDto';
...
export class CompleteDelivery {
  ...
  async execute(dto: CompleteDeliveryDto): Promise<Result<FulfillmentResponse>> {
    ...
    const result = fulfillment.completeDelivery(dto.riderId);

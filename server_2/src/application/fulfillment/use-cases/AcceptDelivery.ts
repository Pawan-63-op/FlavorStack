...
import { AcceptDeliveryDto } from '../dtos/AcceptDeliveryDto';
...
export class AcceptDelivery {
  ...
  async execute(dto: AcceptDeliveryDto): Promise<Result<FulfillmentResponse>> {
    ...
    const result = fulfillment.acceptByRider(dto.riderId);

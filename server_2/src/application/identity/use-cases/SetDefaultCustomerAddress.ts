...
import { SetDefaultAddressDto } from '../dtos/AddressDtos';
import { AddressResponse } from '../responses/AddressResponse';
import { toAddressListResponse } from '../responses/addressMappers';

export class SetDefaultCustomerAddress {
  constructor(private userRepo: IUserRepository) {}

  async execute(dto: SetDefaultAddressDto): Promise<Result<AddressResponse[]>> {
    ...
    user.setDefaultAddress(dto.addressId);

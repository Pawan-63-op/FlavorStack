...
export const NOTIFICATION_TEMPLATE_SEEDS: readonly TemplateSeed[] = [
  ...
  },
  {
    ...
    bodyTemplate:
      'We received a password reset request for {{email}}. Your reset code is {{code}} — it expires in 15 minutes. ' +
      'Enter it at {{resetUrl}} to choose a new password. If you did not request this, you can ignore this email.',
  },
  {
    key: 'order_confirmed',
